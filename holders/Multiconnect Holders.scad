...
Connection_Type = "Multiconnect - openGrid"; // [Multipoint, Multiconnect - Multiboard, Multiconnect - openGrid, Multiconnect - Custom Size, GOEWS, Command Strip]

/* [Internal Dimensions] */
//Height (in mm) from the top of the back to the base of the internal floor
internalHeight = 65.0; //.1
//Width (in mm) of the internal dimension or item you wish to hold
internalWidth = 55.0; //.1
//Length (i.e., distance from back) (in mm) of the internal dimension or item you wish to hold
internalDepth = 31.0; //.1
...
Multiconnect_Stop_Distance_From_Back = 23;
